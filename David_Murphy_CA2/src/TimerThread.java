...
public class TimerThread implements Runnable {
	...
	public void run() {
	//	String elapsed=convertToHMSString(elapsedSeconds);
		//String countDown=convertToHMSString(countdownSeconds);
		while(running&&countdownSeconds!=0) {
			...
			if(countdownSeconds==0) {
				JOptionPane.showMessageDialog(countdownField,"Time Up");
			}
		}
	...
	public synchronized long getCountdownSeconds() {
